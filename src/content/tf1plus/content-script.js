...
(() => {
  ...
  // src/content/tf1plus/detector.ts
  var EMBEDDED_JSON_VARS = ["__NUXT__", "__APOLLO_STATE__", "__INITIAL_STATE__"];
  function detectTf1PlusEpisode(doc = document, url = location.href) {
  ...
  // src/content/tf1plus/history.ts
  function scanTf1PlusHistory(doc = document) {
  ...
  // src/content/tf1plus/content-script.ts
