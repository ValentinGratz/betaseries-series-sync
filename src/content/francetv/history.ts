...
/**
 * Attempts to read France.tv's own "reprendre la lecture" / history UI, when the
 ...
 *
 * Verified capability: none of France.tv's actual history page markup could be
 ...
 */
export function scanFranceTvHistory(doc: Document = document): DetectedEpisode[] | null {
