...
/**
 * Attempts to read M6+'s own "reprendre la lecture" / history UI, when the
 ...
 *
 * Verified capability: none of M6+'s actual history page markup could be
 ...
 */
export function scanM6PlusHistory(doc: Document = document): DetectedEpisode[] | null {
